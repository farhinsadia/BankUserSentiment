...
sample_data = pd.DataFrame({
    ...
    # --- NEW: Added a 'url' column with placeholder links ---
    'url': [
        ...
        'https://example.com/posts/10',
        'https://example.com/posts/11',
    ...
    'date': pd.to_datetime(['2024-01-01', '2024-01-02', '2024-01-03', '2024-01-04', '2024-01-05', 
                           ...
                           '2024-01-11', '2024-01-12', '2024-01-13', '2024-01-14', '2024-01-18']),
    'likes': [45, 12, 5, 89, 34, 8, 15, 67, 102, 22, 18, 33, 50, 41, 25],
    'shares': [5, 2, 1, 15, 8, 1, 3, 12, 25, 4, 2, 6, 9, 7, 5],
    'comments': [10, 3, 2, 22, 9, 3, 5, 14, 30, 5, 4, 8, 11, 10, 15],
...
# Note: Plain text files cannot contain structured data like URLs,
# so comments from these files will not be linkable.
