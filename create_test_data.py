...
sample_data = pd.DataFrame({
    ...
    'location': ['Dhaka', 'Chittagong', 'Dhaka', 'Sylhet', 'Dhaka', 'Rajshahi',
                 ...
                 'Dhaka', 'Sylhet'],
    # --- NEW LINK COLUMN ---
    'link': [f'https://social.example.com/posts/{i}' for i in range(1, 15)]
})
...
# Note: Simple .txt files don't support extra columns like links.
# This functionality will work best with CSV files for comments/reviews too.
